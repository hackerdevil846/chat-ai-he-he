    ...
    try {
      ...
      switch (command) {
        case "deposit":
          ...
          if (userMoney < amount) {
            return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝑩𝒂𝒏𝒌 �🏦]\n\n❏𝒀𝒐𝒖 𝒅𝒐𝒏'𝒕 𝒉𝒂𝒕𝒉𝒆 𝒓𝒆𝒒𝒖𝒊𝒓𝒆𝒅 𝒂𝒎𝒐𝒖𝒏𝒕 𝒕𝒐 𝒅𝒆𝒑𝒐𝒔𝒊𝒕 ✖️•\n\n╚════ஜ۩۞۩ஜ═══╝");
          }
        ...
        case "interest":
          ...
          if (bankData[user].bank <= 0) {
            return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝑩𝒂𝒏𝒌 🏦]\n\n❏𝒀𝒐𝒖 𝒅𝒐𝒏'𝒕 𝒉𝒂𝒗𝒆 𝒂𝒏𝒚 𝒎𝒐𝒏𝒆𝒚 𝒊𝒏 𝒚𝒐𝒖𝒓 𝒃𝒂𝒏𝒌 𝒂𝒄𝒄𝒐𝒖𝒏𝒕 𝒕𝒐 𝒆𝒂𝒓𝒏 𝒊𝒏𝒕𝒆𝒓𝒆𝒓𝒔𝒕 💸🥱•\n\n╚════ஜ۩۞۩ஜ═══╝");
          }
        ...
        case "payloan":
          ...
          return message.reply(`╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝑩𝒂𝒏𝒌 🏦]\n\n❏𝑺𝒖𝒄𝒄𝒆𝒔𝒔𝒇𝒖𝒍𝒍𝒚 𝒓𝒆𝒑𝒂𝒊𝒅 $${amount} 𝒕𝒐𝒘𝒂𝒓𝒅𝒔 𝒚𝒐𝒖𝒓 𝒍𝒐𝒂𝒏. 𝒀𝒐𝒖𝒓 𝒄𝒖𝒓𝒓𝒆𝒏𝒕 𝒍𝒐𝒂𝒏 𝒕𝒐 𝒑𝒂𝒚: $${bankData[user].loan} ✅•\n\n╚════ஜ۩۞۩ஜ═══╝`);
          break;

        default:
          return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝑩𝒂𝒏𝒌 🏦]\n\n❏𝑷𝒍𝒆𝒂𝒔𝒆 𝒖𝒔𝒆 𝒐𝒏𝒆 𝒐𝒇 𝒕𝒉𝒆 𝒇𝒐𝒍𝒍𝒐𝒘𝒊𝒏𝒈 𝒗𝒂𝒍𝒊𝒅 𝒄𝒐𝒞𝒐𝒎𝒎𝒂𝒏𝒅𝒔: 𝒅𝒆𝒑𝒐𝒔𝒊𝒕, 𝒘𝒊𝒕𝒉𝒅𝒓𝒂𝒘, 𝒃𝒂𝒍𝒂𝒏𝒄𝒆, 𝒊𝒏𝒕𝒆𝒓𝒆𝒔𝒕, 𝒕𝒓𝒂𝒏𝒔𝒇𝒆𝒓, 𝒓𝒊𝒄𝒉𝒆𝒔𝒕, 𝒍𝒐𝒂𝒏, 𝒑𝒂𝒚𝒍𝒐𝒂𝒏\n\n╚════ஜ۩۞۩ஜ═══╝");
      }
    } catch (error) {
