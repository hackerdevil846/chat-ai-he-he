...
module.exports.onStart = async function({ message, args, event }) {
    ...
    if (args[0] && !isNaN(args[0])) {
        ...
        if (choice < 1 || choice > doyaContent.length) {
            return message.reply(`⚠️ অবৈধ নির্বাচন! দয়া করে 1-${doyaContent.length} এর মধ্যে একটি নম্বর লিখুন।`, threadID, messageID);
        }
        ...
        try {
            ...
            return message.reply("⚠️ দোয়া পাঠানো সম্ভব হয়নি, পরে আবার চেষ্টা করুন", threadID, messageID);
        }
    }
