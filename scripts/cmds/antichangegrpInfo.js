...
module.exports.config = {
    ...
    category: "box",
    shortDescription: {
        en: "𝑃𝑟𝑒𝑣𝑒𝑛𝑡𝑠 𝑢𝑛𝑎𝑢𝑡ℎ𝑜𝑟𝑖𝑧𝑒𝑑 𝑔𝑟𝑜𝑢𝑝 𝑐ℎ𝑎𝑛𝑔𝑒𝑠"
    },
    longDescription: {
        en: "𝑃𝑟𝑒𝑣𝑒𝑛𝑡𝑠 𝑢𝑛𝑎𝑢𝑡ℎ𝑜𝑟𝑖𝑧𝑒𝑑 𝑔𝑟𝑜𝑢𝑝 𝑛𝑎𝑚𝑒 𝑎𝑛𝑑 𝑖𝑚𝑎𝑔𝑒 𝑐ℎ𝑎𝑛𝑔𝑒𝑠"
    },
    guide: {
        en: "{p}antichange [𝑜𝑛/𝑜𝑓𝑓]"
    },
    dependencies: {
        "fs-extra": "",
        "path": ""
...
module.exports.onStart = async function({ message, args, event, threadsData, api, global }) {
    try {
        ...
        if (subCommand === "on") {
            ...
            if (!activeGroups[threadID]) {
                ...
                return await message.reply("✅ 𝐴𝑛𝑡𝑖-𝑐ℎ𝑎𝑛𝑔𝑒 𝑓𝑒𝑎𝑡𝑢𝑟𝑒 ℎ𝑎𝑠 𝑏𝑒𝑒𝑛 𝑎𝑐𝑡𝑖𝑣𝑎𝑡𝑒𝑑 𝑓𝑜𝑟 𝑡ℎ𝑖𝑠 𝑔𝑟𝑜𝑢𝑝.");
            } else {
                return await message.reply("⚠️ 𝐴𝑛𝑡𝑖-𝑐ℎ𝑎𝑛𝑔𝑒 𝑖𝑠 𝑎𝑙𝑟𝑒𝑎𝑑𝑦 𝑎𝑐𝑡𝑖𝑣𝑒 𝑓𝑜𝑟 𝑡ℎ𝑖𝑠 𝑔𝑟𝑜𝑢𝑝.");
            }
            ...
            if (activeGroups[threadID]) {
                ...
                return await message.reply("🚫 𝐴𝑛𝑡𝑖-𝑐ℎ𝑎𝑛𝑔𝑒 𝑓𝑒𝑎𝑡𝑢𝑟𝑒 ℎ𝑎𝑠 𝑏𝑒𝑒𝑛 𝑑𝑒𝑎𝑐𝑡𝑖𝑣𝑎𝑡𝑒𝑑 𝑓𝑜𝑟 𝑡ℎ𝑖𝑠 𝑔𝑟𝑜𝑢𝑝.");
            } else {
                return await message.reply("⚠️ 𝐴𝑛𝑡𝑖-𝑐ℎ𝑎𝑛𝑔𝑒 𝑖𝑠 𝑛𝑜𝑡 𝑎𝑐𝑡𝑖𝑣𝑒 𝑓𝑜𝑟 𝑡ℎ𝑖𝑠 𝑔𝑟𝑜𝑢𝑝.");
            }
        } else {
            return await message.reply("⚠️ 𝐼𝑛𝑣𝑎𝑙𝑖𝑑 𝑜𝑝𝑡𝑖𝑜𝑛. 𝑈𝑠𝑒: `𝑎𝑛𝑡𝑖𝑐ℎ𝑎𝑛𝑔𝑒 𝑜𝑛` 𝑜𝑟 `𝑎𝑛𝑡𝑖𝑐ℎ𝑎𝑛𝑔𝑒 𝑜𝑓𝑓`.");
        }
    } catch (error) {
        console.error("𝐴𝑛𝑡𝑖𝑐ℎ𝑎𝑛𝑔𝑒 𝐶𝑜𝑚𝑚𝑎𝑛𝑑 𝐸𝑟𝑟𝑜𝑟:", error);
        try {
            await message.reply("⚠️ 𝐸𝑟𝑟𝑜𝑟 𝑜𝑐𝑐𝑢𝑟𝑟𝑒𝑑. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛.");
        } catch (e) {
            console.error("𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑠𝑒𝑛𝑑 𝑒𝑟𝑟𝑜𝑟 𝑟𝑒𝑝𝑙𝑦:", e);
        }
    }
};
