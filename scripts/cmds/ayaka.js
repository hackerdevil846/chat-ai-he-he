...
module.exports = {
  config: {
    ...
    category: "random-img",
    shortDescription: {
      en: "𝑨𝒚𝒂𝒌𝒂 𝒆𝒓 𝒓𝒂𝒏𝒅𝒐𝒎 𝒊𝒎𝒂𝒈𝒆"
    },
    longDescription: {
      en: "𝑺𝒆𝒏𝒅𝒔 𝒓𝒂𝒏𝒅𝒐𝒎 𝑨𝒚𝒂𝒌𝒂 𝒊𝒎𝒂𝒈𝒆𝒔"
    },
    guide: {
      en: "{p}ayaka"
    },
  ...
  onStart: async function({ message, event, Currencies }) {
    try {
      const link = [
      ...
      console.error("Ayaka command error:", error);
      await message.reply("❌ 𝑭𝒂𝒊𝒍𝒆𝒅 𝒕𝒐 𝒍𝒐𝒂𝒅 𝑨𝒚𝒂𝒌𝒂 𝒊𝒎𝒂𝒈𝒆. 𝑷𝒍𝒆𝒂𝒔𝒆 𝒕𝒓𝒚 𝒂𝒈𝒂𝒊𝒏 𝒍𝒂𝒕𝒆𝒓.");
    }
  }
};
