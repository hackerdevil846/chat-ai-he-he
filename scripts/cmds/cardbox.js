...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "𝑨𝒔𝒊𝒇 𝑴𝒂𝒉𝒎𝒖𝒅",
  description: "𝑮𝒓𝒐𝒖𝒑 𝒊𝒏𝒇𝒐𝒓𝒎𝒂𝒕𝒊𝒐𝒏 𝒄𝒂𝒓𝒅",
...
/*---------------------------------------------*/
  ...
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`👥 𝑺𝒐𝒅𝒐𝒔𝒔𝒐: ${threadMem}`, 439, 199);
  ctx.fillText(`👑 𝑨𝒅𝒎𝒊𝒏: ${qtv}`, 439, 243);
  ctx.fillText(`🚹 𝑪𝒉𝒆𝒍𝒆: ${nam}`, 439, 287);
  ctx.fillText(`🚺 𝑴𝒆𝒚𝒆: ${nu}`, 439, 331);
  ctx.fillText(`💬 𝑴𝒆𝒔𝒔𝒂𝒈𝒆: ${sl}`, 439, 379);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#000000";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`📦 𝑰𝑫 𝑩𝒐𝒙: ${id}`, 18, 470);
  ctx.font = `${fontsOthers}px Lobster`;
  ctx.fillStyle = "#000000";
  ctx.textAlign = "start";
  fontSize = 20;
  ctx.fillText(`➕ 𝑨𝒓𝒐 ${parseInt(threadMem)-3} 𝒋𝒐𝒏 𝒔𝒐𝒅𝒐𝒔𝒔𝒐 𝒅𝒆𝒓 𝒔𝒉𝒐𝒏𝒈𝒆...`, 607, 453);
  ctx.beginPath();
