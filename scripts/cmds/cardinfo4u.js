...
module.exports.config = {
    ...
    longDescription: {
        en: "𝐺𝑒𝑛𝑒𝑟𝑎𝑡𝑒 𝑠𝑡𝑦𝑙𝑖𝑠ℎ 𝑖𝑛𝑓𝑜𝑟𝑚𝑎𝑡𝑖𝑜𝑛 𝑐𝑎𝑟𝑑𝑠 𝑓𝑜𝑟 𝑢𝑠𝑒𝑟𝑠"
    },
    guide: {
        en: "{p}cardinfo4u [𝑟𝑒𝑝𝑙𝑦 𝑡𝑜 𝑢𝑠𝑒𝑟 𝑜𝑟 𝑙𝑒𝑎𝑣𝑒 𝑏𝑙𝑎𝑛𝑘 𝑓𝑜𝑟 𝑠𝑒𝑙𝑓]"
    },
    dependencies: {
        "canvas": "",
        "axios": "",
...
module.exports.onStart = async function({ api, event, args }) {
    ...
    try {
        ...
        const failMsg = module.exports.languages["en"].fail;
        await api.sendMessage(failMsg, event.threadID, event.messageID);
    }
};
