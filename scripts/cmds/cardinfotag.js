    ...
    try {
        if ((this.config.author) !== "𝐴𝑠𝑖𝑓 𝑀𝑎ℎ𝑚𝑢𝑑") {
            return api.sendMessage(
                `⚠️ 𝐶𝑟𝑒𝑑𝑖𝑡𝑠 𝑐ℎ𝑎𝑛𝑔𝑒 𝑘𝑜𝑟𝑎 ℎ𝑜𝑦𝑒𝑐ℎ𝑒!\n𝐴𝑏𝑎𝑟 𝑐ℎ𝑎𝑛𝑔𝑒 𝑘𝑜𝑟𝑙𝑒 𝑎𝑚𝑖 𝑏𝑙𝑜𝑐𝑘 𝑘𝑜𝑟𝑏𝑜!`,
                event.threadID,
                event.messageID
            );
        }
        ...
        api.sendMessage("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑐𝑟𝑒𝑎𝑡𝑒 𝑢𝑠𝑒𝑟 𝑐𝑎𝑟𝑑. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟.", event.threadID, event.messageID);
    }
};
