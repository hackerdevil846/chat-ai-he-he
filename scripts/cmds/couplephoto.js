module.exports = {
    ...
    onStart: async function ({ event, message, usersData, args }) {
        try {
            ...
            const templatePath = path.resolve(dirMaterial, "couple_template.png");
            ...
            const pathImg = path.resolve(dirMaterial, `couple_photo_${one}_${two}.png`);
            const avatarOne = path.resolve(dirMaterial, `avatar_${one}.png`);
            const avatarTwo = path.resolve(dirMaterial, `avatar_${two}.png`);
