  ...
  run: async function({ api, event, args }) {
    ...
    if (args[0] && !isNaN(args[0])) {
      ...
      if (choice < 1 || choice > doyaContent.length) {
        return api.sendMessage(`⚠️ অবৈধ নির্বাচন! দয়া করে 1-${doyaContent.length} এর মধ্যে একটি নম্বর লিখুন।`, threadID, messageID);
      }
      ...
      try {
        ...
        return api.sendMessage("⚠️ দোয়া পাঠানো সম্ভব হয়নি, পরে আবার চেষ্টা করুন", threadID, messageID);
      }
    }
    ...
    menuMessage += "\n💫 আপনার পছন্দের দোয়ার নম্বরটি লিখুন (1-8)";
