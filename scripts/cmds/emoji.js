...
module.exports.run = async ({ event, api, args }) => {
    ...
    if (!type || !text) {
        return api.sendMessage("𝑽𝒖𝒍 𝒍𝒆𝒌𝒉𝒆𝒏: 𝒆𝒎𝒐𝒋𝒊 𝒆𝒏 <𝒕𝒆𝒙𝒕>\n𝒂𝒕𝒉𝒂𝒃𝒂\n𝒆𝒎𝒐𝒋𝒊 𝒅𝒆 <𝒕𝒆𝒙𝒕>", event.threadID, event.messageID);
    }
    ...
    if (type == 'encode' || type == "en") {
        ...
        text = text.replace(/\./g, ' ');
        return api.sendMessage(`🔓 𝑫𝒆𝒄𝒓𝒚𝒑𝒕𝒆𝒅:\n${text}`, event.threadID, event.messageID);
    }
    else {
        return api.sendMessage("𝑽𝒖𝒍 𝒍𝒆𝒌𝒉𝒆𝒏: 𝒆𝒎𝒐𝒋𝒊 𝒆𝒏 <𝒕𝒆𝒙𝒕>\n𝒂𝒕𝒉𝒂𝒃𝒂\n𝒆𝒎𝒐𝒋𝒊 𝒅𝒆 <𝒕𝒆𝒙𝒕>", event.threadID, event.messageID);
    }
