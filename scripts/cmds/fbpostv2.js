...
const textWaiting = "𝐼𝑚𝑎𝑔𝑒 𝑝𝑟𝑒𝑝𝑎𝑟𝑎𝑡𝑖𝑜𝑛, 𝑝𝑙𝑒𝑎𝑠𝑒 𝑤𝑎𝑖𝑡 𝑎 𝑚𝑜𝑚𝑒𝑛𝑡 🕐";
...
module.exports.config = {
    ...
    category: "𝑒𝑑𝑖𝑡-𝑖𝑚𝑎𝑔𝑒",
    shortDescription: {
        en: "𝐶𝑟𝑒𝑎𝑡𝑒 𝑎 𝑠𝑡𝑦𝑙𝑖𝑠ℎ 𝑇𝑤𝑖𝑡𝑡𝑒𝑟 𝑝𝑜𝑠𝑡 🐦"
    },
    longDescription: {
        en: "𝐶𝑟𝑒𝑎𝑡𝑒 𝑎 𝑠𝑡𝑦𝑙𝑖𝑠ℎ 𝑇𝑤𝑖𝑡𝑡𝑒𝑟 𝑝𝑜𝑠𝑡 𝑤𝑖𝑡ℎ 𝑦𝑜𝑢𝑟 𝑡𝑒𝑥𝑡"
    },
    guide: {
        en: "{p}tweet-tag [𝑡𝑒𝑥𝑡]"
    },
...
module.exports.languages = {
    "en": {
        "missingInput": "❌ 𝑃𝑙𝑒𝑎𝑠𝑒 𝑒𝑛𝑡𝑒𝑟 𝑡ℎ𝑒 𝑡𝑒𝑥𝑡 𝑦𝑜𝑢 𝑤𝑎𝑛𝑡 𝑡𝑜 𝑡𝑤𝑒𝑒𝑡!"
    }
};
...
module.exports.onStart = async function({ api, event, args, message }) {
    try {
        ...
        await message.reply({
            body: "✅ 𝑇𝑤𝑒𝑒𝑡 𝑐𝑟𝑒𝑎𝑡𝑒𝑑 𝑠𝑢𝑐𝑐𝑒𝑠𝑠𝑓𝑢𝑙𝑙𝑦! 🐦",
        ...
        console.error("𝑇𝑤𝑒𝑒𝑡 𝐸𝑟𝑟𝑜𝑟:", error);
