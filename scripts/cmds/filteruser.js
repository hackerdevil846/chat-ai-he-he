...
module.exports.run = async function ({ api, args, event, threadsData, message, getLang }) {
...
module.exports.handleReaction = async function ({ api, event, Reaction, threadsData, message, getLang }) {
