...
module.exports = {
    ...
    onLoad: async function() {
        ...
        const templatePath = path.join(cacheDir, 'fingering.png');
        ...
        try {
            ...
            if (!fs.existsSync(templatePath)) {
                console.warn("⚠️ Template 'fingering.png' not found! Please place it in cache folder.");
    ...
    onStart: async function({ message, event, args }) {
        ...
        try {
            ...
            if (generatedImagePath && fs.existsSync(generatedImagePath)) {
                ...
                await message.reply("❌ Failed to create image. Please check if template exists and try again.");
            }
