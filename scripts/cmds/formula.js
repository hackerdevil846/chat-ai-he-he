    ...
    try {
        if (!args[0]) {
            return api.sendMessage(
                ...
                "➝ {p}formula 𝑚𝑎𝑡ℎ - 𝑉𝑖𝑒𝑤 𝑚𝑎𝑡ℎ𝑒𝑚𝑎𝑡𝑖𝑐𝑠 𝑓𝑜𝑟𝑚𝑢𝑙𝑎𝑠\n" +
                "➝ {p}formula 𝑝ℎ𝑦𝑠𝑖𝑐𝑠 - 𝑉𝑖𝑒𝑤 𝑝ℎ𝑦𝑠𝑖𝑐𝑠 𝑓𝑜𝑟𝑚𝑢𝑙𝑎𝑠", 
                event.threadID, 
                event.messageID
            );
        }
    ...
    try {
        ...
        if (link && msg && fileName) {
            ...
            try {
                ...
                await api.sendMessage('🔄 𝐿𝑜𝑎𝑑𝑖𝑛𝑔 𝑑𝑎𝑡𝑎...', event.threadID, event.messageID);
                ...
                api.sendMessage("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑑𝑜𝑤𝑛𝑙𝑜𝑎𝑑 𝑡ℎ𝑒 𝑓𝑜𝑟𝑚𝑢𝑙𝑎 𝑖𝑚𝑎𝑔𝑒!", event.threadID, event.messageID);
            }
        }
    } catch (error) {
        console.error("𝐸𝑟𝑟𝑜𝑟:", error);
