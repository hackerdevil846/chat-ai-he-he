...
module.exports.onStart = async function({ message, event, args }) {
    try {
        ...
        if (!mention[0]) {
            return message.reply("✨ 𝐷𝑎𝑦𝑎 𝑘𝑜𝑟𝑒 𝑒𝑘𝑗𝑜𝑛 𝑘𝑒 𝑚𝑒𝑛𝑡𝑖𝑜𝑛 𝑘𝑜𝑟𝑢𝑛! 💝", threadID, messageID);
        }
        ...
        message.reply("❌ 𝐴𝑛 𝑒𝑟𝑟𝑜𝑟 𝑜𝑐𝑐𝑢𝑟𝑒𝑑 𝑤ℎ𝑖𝑙𝑒 𝑝𝑟𝑜𝑐𝑒𝑠𝑠𝑖𝑛𝑔 𝑖𝑚𝑎𝑔𝑒");
    }
};
