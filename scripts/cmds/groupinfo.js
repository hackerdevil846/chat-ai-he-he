...
module.exports.config = {
    ...
    category: "𝑢𝑡𝑖𝑙𝑖𝑡𝑦",
    guide: {
        en: "{p}groupinfo [--𝑐𝑜𝑙𝑜𝑢𝑟 𝑡𝑒𝑥𝑡] [--𝑏𝑔𝑐𝑜𝑙𝑜𝑢𝑟 𝑖𝑚𝑔𝑈𝑅𝐿] [--𝑎𝑑𝑚𝑖𝑛𝑐𝑜𝑙𝑜𝑢𝑟 𝑐𝑙𝑟] [--𝑚𝑒𝑚𝑏𝑒𝑟𝑐𝑜𝑙𝑜𝑢𝑟 𝑐𝑙𝑟]"
    },
    dependencies: {
        "fs-extra": "",
        "axios": "",
...
module.exports.onStart = async function({ api, event, usersData, message, args }) {
    try {
        // Check dependencies
        ...
        await message.reply(`❌ ${toMathBoldItalic("Error occurred")}: ${err.message}`);
    }
};
