...
module.exports = {
 config: {
  ...
  role: 1,
  description: {
   en: "Auto-detects inappropriate words and sends a warning image (toggleable)"
  },
  category: "protection",
  guide: {
   en: "Use {pn} on/off to toggle detection\nUse {pn} to check status"
  }
 },
 ...
 onStart: async function ({ message, args, globalData }) {
  ...
  return message.reply("⚠️ Invalid usage. Use: {pn} on / off");
 },
