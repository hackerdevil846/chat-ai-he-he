...
module.exports.config = {
    ...
    category: "user",
    shortDescription: {
        en: "📱 𝑃𝑙𝑎𝑦𝑠𝑡𝑜𝑟𝑒 𝑠𝑡𝑦𝑙𝑒 𝑢𝑠𝑒𝑟 𝑖𝑛𝑓𝑜 𝑐𝑎𝑟𝑑"
    },
    longDescription: {
        en: "𝐺𝑒𝑛𝑒𝑟𝑎𝑡𝑒𝑠 𝑎 𝑃𝑙𝑎𝑦𝑆𝑡𝑜𝑟𝑒-𝑠𝑡𝑦𝑙𝑒 𝑢𝑠𝑒𝑟 𝑖𝑛𝑓𝑜𝑟𝑚𝑎𝑡𝑖𝑜𝑛 𝑐𝑎𝑟𝑑"
    },
    guide: {
        en: "{p}playstore [𝑚𝑒𝑛𝑡𝑖𝑜𝑛/𝑟𝑒𝑝𝑙𝑦/𝑛𝑜𝑛𝑒]"
    },
    dependencies: {
        "axios": "",
        "fs-extra": "",
...
module.exports.onStart = async function({ api, event, args, Users }) {
    try {
        ...
        ctx.fillText("📂 𝑃𝑟𝑜𝑓𝑖𝑙𝑒 𝑉𝑖𝑠𝑖𝑡𝑒𝑑", 200, 190);
        ...
        ctx.fillText("🔎 𝑉𝑖𝑒𝑤 𝑃𝑟𝑜𝑓𝑖𝑙𝑒", 220, 250);
        ...
        return api.sendMessage(
            {
                body: `📱 𝑃𝑙𝑎𝑦𝑠𝑡𝑜𝑟𝑒 𝑆𝑡𝑦𝑙𝑒 𝑈𝑠𝑒𝑟 𝐶𝑎𝑟𝑑\n━━━━━━━━━━━━━━━━\n👤 𝑈𝑠𝑒𝑟: ${name}\n🆔 𝐼𝐷: ${id}`,
        ...
        console.error("𝑃𝑙𝑎𝑦𝑠𝑡𝑜𝑟𝑒 𝐸𝑟𝑟𝑜𝑟:", err);
        return api.sendMessage(`❌ 𝐸𝑟𝑟𝑜𝑟: ${err.message}`, event.threadID, event.messageID);
    }
};
