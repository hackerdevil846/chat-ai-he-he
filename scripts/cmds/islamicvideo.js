...
module.exports.languages = {
    "en": {
        "downloading": "📥 | 𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑𝑖𝑛𝑔 𝐼𝑠𝑙𝑎𝑚𝑖𝑐 𝑐𝑜𝑛𝑡𝑒𝑛𝑡, 𝑝𝑙𝑒𝑎𝑠𝑒 𝑤𝑎𝑖𝑡...",
        "error": "❌ | 𝐶𝑜𝑢𝑙𝑑 𝑛𝑜𝑡 𝑟𝑒𝑡𝑟𝑖𝑒𝑣𝑒 𝐼𝑠𝑙𝑎𝑚𝑖𝑐 𝑐𝑜𝑛𝑡𝑒𝑛𝑡. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟.",
        "message": "✨ 𝑨𝒍𝒔𝒂𝒍𝒂𝒎𝒖 𝑨𝒍𝒂𝒊𝒌𝒖𝒎 𝑾𝒂 𝑹𝒂𝒉𝒎𝒂𝒕𝒖𝒍𝒍𝒂𝒉𝒊 𝑾𝒂 𝑩𝒂𝒓𝒂𝒌𝒂𝒕𝒖𝒉𝒖 ✨\n\n📿 𝐻𝑒𝑟𝑒 𝑖𝑠 𝑎𝑛 𝐼𝑠𝑙𝑎𝑚𝑖𝑐 𝑣𝑖𝑑𝑒𝑜 𝑓𝑜𝑟 𝑟𝑒𝑓𝑙𝑒𝑐𝑡𝑖𝑜𝑛 𝑎𝑛𝑑 𝑖𝑛𝑠𝑝𝑖𝑟𝑎𝑡𝑖𝑜𝑛:\n\n🌙 𝑀𝑎𝑦 𝐴𝑙𝑙𝑎ℎ 𝑏𝑙𝑒𝑠𝑠 𝑦𝑜𝑢 𝑎𝑛𝑑 𝑔𝑢𝑖𝑑𝑒 𝑢𝑠 𝑎𝑙𝑙 𝑡𝑜 𝑡ℎ𝑒 𝑟𝑖𝑔ℎ𝑡 𝑝𝑎𝑡ℎ 🕋"
    }
};
...
module.exports.onStart = async function({ message, event, api }) {
    ...
    try {
        await message.reply(module.exports.languages.en.downloading);
