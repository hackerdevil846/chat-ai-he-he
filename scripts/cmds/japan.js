...
module.exports.config = {
    ...
    countDown: 5,
    role: 0,
    category: "𝑟𝑎𝑛𝑑𝑜𝑚-𝑖𝑚𝑎𝑔𝑒",
    shortDescription: {
        en: "𝑅𝑎𝑛𝑑𝑜𝑚 𝐶𝑜𝑠𝑝𝑙𝑎𝑦 𝑃ℎ𝑜𝑡𝑜𝑠"
    },
    longDescription: {
        en: "𝑅𝑎𝑛𝑑𝑜𝑚 𝐶𝑜𝑠𝑝𝑙𝑎𝑦 𝑃ℎ𝑜𝑡𝑜𝑠 𝑓𝑟𝑜𝑚 𝐽𝑎𝑝𝑎𝑛𝑒𝑠𝑒 𝑐𝑜𝑠𝑝𝑙𝑎𝑦𝑒𝑟𝑠"
    },
    guide: {
        en: "{p}japan"
    },
...
module.exports.languages = {
    "en": {
        "loading": "📥 𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑𝑖𝑛𝑔 𝑖𝑚𝑎𝑔𝑒...",
        "sent": "🌸 𝐶𝑜𝑠𝑝𝑙𝑎𝑦 𝑃ℎ𝑜𝑡𝑜 🌸",
        "err": "⚠️ 𝐼𝑚𝑎𝑔𝑒 𝑙𝑜𝑎𝑑 𝑝𝑟𝑜𝑏𝑙𝑒𝑚! 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟 😢"
    },
    "bn": {
        "loading": "📥 𝐼𝑚𝑎𝑔𝑒 𝑑𝑜𝑤𝑛𝑙𝑜𝑎𝑑𝑖𝑛𝑔...",
        "sent": "🌸 𝐶𝑜𝑠𝑝𝑙𝑎𝑦 𝑃ℎ𝑜𝑡𝑜 🌸",
        "err": "⚠️ 𝐼𝑚𝑎𝑔𝑒 𝑙𝑜𝑎𝑑 𝑝𝑟𝑜𝑏𝑙𝑒𝑚! 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟 😢"
    }
};
...
module.exports.onLoad = function () {
    ...
    try {
        ...
        console.error("𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑐𝑟𝑒𝑎𝑡𝑒 𝑐𝑎𝑐ℎ𝑒 𝑑𝑖𝑟𝑒𝑐𝑡𝑜𝑟𝑦:", e);
    }
};
...
module.exports.onStart = async function({ message, event }) {
    try {
        ...
        console.log(`𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑𝑖𝑛𝑔 𝑖𝑚𝑎𝑔𝑒 (${randomIndex + 1}/${links.length}): ${randomLink}`);
        ...
        console.error("𝐸𝑟𝑟𝑜𝑟 𝑖𝑛 𝑗𝑎𝑝𝑎𝑛 𝑐𝑜𝑚𝑚𝑎𝑛𝑑:", error);
        
        const errMsg = module.exports.languages["en"].err;
