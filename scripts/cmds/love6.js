...
module.exports.onStart = async function ({ event, api, args, message }) {
    ...
    if (Object.keys(mentions).length === 0) {
        return message.reply('💝 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑎𝑔 1 𝑝𝑒𝑟𝑠𝑜𝑛 𝑡𝑜 𝑐𝑟𝑒𝑎𝑡𝑒 𝑙𝑜𝑣𝑒 𝑖𝑚𝑎𝑔𝑒', threadID, messageID);
    }
    ...
    try {
        await message.reply("🔄 𝐶𝑟𝑒𝑎𝑡𝑖𝑛𝑔 𝑙𝑜𝑣𝑒 𝑖𝑚𝑎𝑔𝑒...", threadID, messageID);
        ...
        await message.reply(messageObj, threadID, () => {
        ...
        await message.reply("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑐𝑟𝑒𝑎𝑡𝑒 𝑙𝑜𝑣𝑒 𝑖𝑚𝑎𝑔𝑒. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟.", threadID, messageID);
    }
};
