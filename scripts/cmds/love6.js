...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (Object.keys(mentions).length === 0) {
        return api.sendMessage('💝 Please tag 1 person to create love image', threadID, messageID);
    }
    ...
    try {
        api.sendMessage("🔄 Creating love image...", threadID, messageID);
        ...
        api.sendMessage("❌ Failed to create love image. Please try again later.", threadID, messageID);
    }
};
