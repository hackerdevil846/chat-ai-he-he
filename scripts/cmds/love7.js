...
module.exports = {
  ...
  generateLoveImage: async function(user1ID, user2ID) {
    ...
    baseImage
      .composite(avatar1, 300, 300)  // Position for first avatar
      .composite(avatar2, 600, 300); // Position for second avatar
  ...
  processAvatar: async function(userId) {
    ...
    bordered.composite(avatar.crop(0, 0, size, size), borderSize, borderSize);
