...
module.exports = {
  config: {
    name: "lovecomp",
    aliases: ["lovecalculator", "relationshipmeter"],
    version: "1.0.0",
    author: "𝐴𝑠𝑖𝑓 𝑀𝑎ℎ𝑚𝑢𝑑",
    role: 0,
    category: "fun",
    ...
    try {
      ...
      if (!mentions1) {
        if (args[0] == "info") {
          ...
          return message.reply(`1: 𝑈𝑠𝑒 𝑐𝑜𝑚𝑚𝑎𝑛𝑑 + 𝑡𝑎𝑔\n2: 𝑈𝑠𝑒 𝑐𝑜𝑚𝑚𝑎𝑛𝑑 + 𝑖𝑛𝑓𝑜 𝑜𝑟 𝑓𝑎𝑘𝑒\n\n𝐼𝑛𝑓𝑜: 𝑣𝑖𝑒𝑤 𝑐𝑟𝑒𝑑𝑖𝑡𝑠 𝑎𝑛𝑑 𝑖𝑛𝑓𝑜𝑟𝑚𝑎𝑡𝑖𝑜𝑛\n𝐹𝑎𝑘𝑒: 𝑐𝑟𝑒𝑎𝑡𝑒 𝑓𝑎𝑘𝑒 𝑐𝑜𝑚𝑝𝑎𝑡𝑖𝑏𝑖𝑙𝑖𝑡𝑦 𝑏𝑎𝑛𝑛𝑒𝑟`);
        }
      }
      ...
      if (args[0] == "fake") {
        return message.reply(`𝐸𝑛𝑡𝑒𝑟 ℎ𝑒𝑎𝑟𝑡 𝑣𝑎𝑙𝑢𝑒𝑠 𝑒.𝑔. 8|8|8|8|8`, (err, info) => {
      ...
      message.reply("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑐𝑟𝑒𝑎𝑡𝑒 𝑐𝑜𝑚𝑝𝑎𝑡𝑖𝑏𝑖𝑙𝑖𝑡𝑦 𝑖𝑚𝑎𝑔𝑒.");
    }
  },
  ...
  onReply: async function({ api, event, handleReply, message }) {
    try {
      ...
      switch (handleReply.type) {
        case "create": {
          ...
          if (MissionC.length !== 5 || MissionC.some(isNaN)) {
            return message.reply(`𝐼𝑛𝑣𝑎𝑙𝑖𝑑 𝑓𝑜𝑟𝑚𝑎𝑡. 𝑈𝑠𝑒: 8|8|8|8|8`);
          }
      ...
      message.reply("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑝𝑟𝑜𝑐𝑒𝑠𝑠 𝑟𝑒𝑞𝑢𝑒𝑠𝑡.");
    }
  },
