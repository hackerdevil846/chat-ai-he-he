...
module.exports.languages = {
    "en": {
        "ERR_TEXT": "𝑃𝑙𝑒𝑎𝑠𝑒 𝑒𝑛𝑡𝑒𝑟 𝑡ℎ𝑒 𝑐𝑜𝑚𝑚𝑒𝑛𝑡 𝑡𝑒𝑥𝑡.",
        "SUCCESS": "𝑀𝑎𝑟𝑘 𝑍𝑢𝑐𝑘𝑒𝑛𝑏𝑒𝑟𝑔'𝑠 𝑓𝑎𝑘𝑒 𝑐𝑜𝑚𝑚𝑒𝑛𝑡 📝"
    },
    "bn": {
        "ERR_TEXT": "𝐵𝑜𝑎𝑟𝑑 এ 𝑐𝑜𝑚𝑚𝑒𝑛𝑡 লিখতে 𝑒𝑛𝑡𝑒𝑟 করুন।",
        "SUCCESS": "𝑀𝑎𝑟𝑘 𝑍𝑢𝑐𝑘𝑒𝑟𝑏𝑒𝑟𝑔-এর কমেন্ট 📝"
    }
};
...
module.exports.onStart = async function ({ message, event, args }) {
    try {
        ...
        if (!text) {
            return message.reply(this.languages[lang].ERR_TEXT);
        }
