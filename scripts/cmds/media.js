...
module.exports.onReply = async function({ api, event, handleReply }) {
    try {
        ...
        if (isNaN(choice) || choice < 1 || choice > 6) {
            return api.sendMessage("𝐶ℎ𝑜𝑜𝑠𝑒 𝑓𝑟𝑜𝑚 1 𝑡𝑜 6 𝑜𝑛𝑙𝑦. 𝑖𝑙𝑦 ❤️", event.threadID, event.messageID);
        }
        ...
        if (videoData.status === "fail") {
            return api.sendMessage("𝐶𝑎𝑛𝑛𝑜𝑡 𝑠𝑒𝑛𝑑 𝑡ℎ𝑖𝑠 𝑓𝑖𝑙𝑒.", event.threadID);
        }
        ...
        if (fileSize > 25000000) {
            fs.unlinkSync(path);
            return api.sendMessage("𝐹𝑖𝑙𝑒 𝑠𝑖𝑧𝑒 𝑒𝑥𝑐𝑒𝑒𝑑𝑠 25𝑀𝐵.", event.threadID, event.messageID);
        }
        ...
        api.sendMessage("𝐶𝑎𝑛𝑛𝑜𝑡 𝑠𝑒𝑛𝑑 𝑡ℎ𝑖𝑠 𝑓𝑖𝑙𝑒!", event.threadID, event.messageID);
    }
};
...
module.exports.onStart = async function({ api, event, args }) {
    try {
        if (!args.length) {
            return api.sendMessage("» 𝑆𝑒𝑎𝑟𝑐ℎ 𝑞𝑢𝑒𝑟𝑦 𝑐𝑎𝑛𝑛𝑜𝑡 𝑏𝑒 𝑒𝑚𝑝𝑡𝑦!", event.threadID, event.messageID);
        }
        ...
        api.sendMessage("𝐸𝑟𝑟𝑜𝑟 𝑝𝑟𝑜𝑐𝑒𝑠𝑠𝑖𝑛𝑔 𝑟𝑒𝑞𝑢𝑒𝑠𝑡: " + error.message, event.threadID, event.messageID);
    }
};
