module.exports = {
  config: {
    ...
    shortDescription: {
      ...
      bn: "গ্রুপের সব সদস্যের কোলাজ তৈরি করুন"
    },
    longDescription: {
      en: "𝐶𝑟𝑒𝑎𝑡𝑒 𝑎 𝑐𝑜𝑙𝑙𝑎𝑔𝑒 𝑤𝑖𝑡ℎ 𝑎𝑙𝑙 𝑔𝑟𝑜𝑢𝑝 𝑚𝑒𝑚𝑏𝑒𝑟𝑠' 𝑎𝑣𝑎𝑡𝑎𝑟𝑠",
      bn: "গ্রুপের সব সদস্যের অ্যাভাটার সহ একটি কোলাজ তৈরি করুন"
    },
    guide: {
      en: "{p}memberscollage [𝑠𝑖𝑧𝑒] [#𝑐𝑜𝑙𝑜𝑟] [𝑡𝑖𝑡𝑙𝑒]",
      bn: "{p}memberscollage [𝑠𝑖𝑧𝑒] [#𝑐𝑜𝑙𝑜𝑟] [𝑡𝑖𝑡𝑙𝑒]"
    },
    dependencies: {
      "fs-extra": "", 
      "axios": "", 
  ...
  onStart: async function ({ event, api, args }) {
    ...
    if (args[0] === 'help' || args[0] === '0' || args[0] === '-h') {
      return api.sendMessage(
        '𝑈𝑠𝑎𝑔𝑒: ' + this.config.name + ' [𝑎𝑣𝑡 𝑠𝑖𝑧𝑒]' + ' [𝑐𝑜𝑙𝑜𝑟 𝑐𝑜𝑑𝑒]' + ' [𝑔𝑟𝑜𝑢𝑝 𝑛𝑎𝑚𝑒 (𝑡𝑖𝑡𝑙𝑒)]',
        threadID, 
        messageID
      );
    }
    ...
    /*================CREATE PATH AVATAR===============*/
    api.sendMessage(
      `🍗 𝐸𝑥𝑝𝑒𝑐𝑡𝑒𝑑 𝑖𝑚𝑎𝑔𝑒: ${participantIDs.length}\n🍠 𝐵𝑎𝑐𝑘𝑔𝑟𝑜𝑢𝑛𝑑 𝑠𝑖𝑧𝑒: ${bgX} 𝑥 ${bgY}\n🥑 𝐴𝑣𝑎𝑡𝑎𝑟 𝑠𝑖𝑧𝑒: ${size}\n🥪 𝐶𝑜𝑙𝑜𝑟: ${color}`,
      threadID, 
      messageID
    );
    ...
    try {
      ...
      return api.sendMessage("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑝𝑟𝑜𝑐𝑒𝑠𝑠 𝑖𝑚𝑎𝑔𝑒", threadID, messageID);
    }
    ...
    return api.sendMessage({
      ...
      if (error) {
        console.error("𝐸𝑟𝑟𝑜𝑟 𝑠𝑒𝑛𝑑𝑖𝑛𝑔 𝑖𝑚𝑎𝑔𝑒:", error);
        return api.sendMessage(`❌ 𝐸𝑟𝑟𝑜𝑟: ${error}`, threadID, () => {
          if (fs.existsSync(pathAVT)) fs.unlinkSync(pathAVT);
        }, messageID);
      }
      console.log('𝑆𝑢𝑐𝑐𝑒𝑠𝑠𝑓𝑢𝑙𝑙𝑦 𝑠𝑒𝑛𝑡 𝑖𝑚𝑎𝑔𝑒'); 
      if (fs.existsSync(pathAVT)) fs.unlinkSync(pathAVT);
    }, messageID);
  }
};
