module.exports = {
  config: {
    ...
    hasPermssion: 0,
    credits: "Asif",
    description: "Random panties close-up images",
    category: "nsfw",
    usages: "pantiesclose",
    cooldowns: 5,
    dependencies: {
  ...
  onStart: async function() {}, // Required initialization function

  async onCommand({ api, event }) {
    ...
    try {
      const links = [
        ...
        "https://konachan.net/image/e019ba0c0275dd4f7844c59ff1633267/Konachan.com%20-%20302161%20ass%20braids%20brown_hair%20cameltoe%20close%20long_hair%20morishima_kon%20original%20panties%20ponytail%20underwear%20wet.jpg?0.9835388734187598",
        ...
        "https://konachan.net/jpeg/59d0fc48913bf9044d88eaca7c70479f/Konachan.com%20-%20317190%20apron%20ass%20close%20cropped%20maid%20original%20otokuyou%20panties%20ringo-chan_%28otokuyou%29%20skirt_lift%20thighhighs%20underwear%20white.jpg?0.22817269721930766",
        ...
        "https://konachan.net/jpeg/783f493f35d7a54667b48aca4d5c0e00/Konachan.com%20-%20275260%20ass%20bed%20brown_hair%20cameltoe%20catgirl%20close%20japanese_clothes%20long_hair%20original%20panties%20ponytail%20tail%20underwear%20yu-ta.jpg?0.5654438855838821",
      ...
      const cachePath = path.join(cacheDir, "pantiesclose.jpg");
      ...
      api.sendMessage(
        {
          body: `🌸 Panties Close-up (${links.length} images available)`,
      ...
      console.error("Error in pantiesclose command:", err);
