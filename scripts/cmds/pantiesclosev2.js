module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Asif",
  description: "Project M4a - Panties Closeup Images",
  category: "Random-IMG",
  usages: "pantiesclosev2",
  cooldowns: 3,
  dependencies: {
    "axios": ""
  }
...
module.exports.run = async ({ api, event }) => {
  ...
  try {
    ...
    api.sendMessage("⚠️ Failed to fetch panties image. Please try again later.", event.threadID, event.messageID);
  }
};
