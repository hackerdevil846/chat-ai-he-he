...
📌 𝑼𝒔𝒂𝒈𝒆: 𝒑𝒆𝒕𝒎𝒐𝒏𝒔𝒕𝒆𝒓𝒔 -[𝒐𝒑𝒕𝒊𝒐𝒏]`;
    ...
    switch(args[0]) {
        case "-r":
            try {
                const imgBuffer = await generateWelcomeImage(userName);
                const imgPath = path.join(__dirname, 'cache', 'pet_welcome.jpg');
                ...
                console.error(e);
                return api.sendMessage("❌ 𝑬𝒓𝒓𝒐𝒓 𝒈𝒆𝒏𝒆𝒓𝒂𝒕𝒊𝒏𝒈 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒊𝒎𝒂𝒈𝒆!", event.threadID);
            }
...
📌 𝑹𝒆𝒑𝒍𝒚 𝒘𝒊𝒕𝒉 𝒏𝒖𝒎𝒃𝒆𝒓 𝒕𝒐 𝒗𝒊𝒆𝒘 𝒅𝒆𝒕𝒂𝒊𝒍𝒔`;
        ...
        case "-p":
            return api.sendMessage("🎮 𝑮𝒂𝒎𝒆 𝑺𝒕𝒂𝒓𝒕𝒆𝒅!\n━━━━━━━━━━━━━━━━━━━━━\n𝑨𝒔𝒄𝒉𝒆 𝒂𝒏𝒆𝒌𝒆 𝒂𝒔𝒃𝒆...", event.threadID);

        default:
            return api.sendMessage("⚠️ 𝑰𝒏𝒗𝒂𝒍𝒊𝒅 𝒐𝒑𝒕𝒊𝒐𝒏! 𝑼𝒔𝒆 -𝒉 𝒇𝒐𝒓 𝒉𝒆𝒍𝒑", event.threadID);
    }
};
...
📌 𝑹𝒆𝒑𝒍𝒚 𝒘𝒊𝒕𝒉 𝒊𝒕𝒆𝒎 𝒏𝒖𝒎𝒃𝒆𝒓 𝒕𝒐 𝒑𝒖𝒓𝒄𝒉𝒂𝒔𝒆`;
                    api.sendMessage(food, event.threadID);
                    break;
...
━━━━━━━━━━━━━━━━━━━━━
📌 𝑹𝒆𝒑𝒍𝒚 𝒘𝒊𝒕𝒉 𝒊𝒕𝒆𝒎 𝒏𝒖𝒎𝒃𝒆𝒓 𝒕𝒐 𝒑𝒖𝒓𝒄𝒉𝒂𝒔𝒆`;
                    api.sendMessage(weapons, event.threadID);
                    break;
