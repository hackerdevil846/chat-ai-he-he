...
module.exports = {
 ...
 longDescription: { en: "Usage: +placeholder text [backgroundColor]. Background color supports hex (#ff0000) or color names." },
 category: "fun",
 guide: { en: "+placeholder Hello world red\n+placeholder Welcome #00ff00" }
 },

 onStart: async function ({ message, args }) {
 if (args.length === 0)
 return message.reply("❗ Please provide text. Example: `+placeholder Hello world red`");
