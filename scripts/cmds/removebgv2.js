...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "𝑨𝒔𝒊𝒇 𝑴𝒂𝒉𝒎𝒖𝒅",
    description: "🖼️ Remove image backgrounds with enhanced API handling and stylish canvas output",
    category: "media",
...
module.exports.run = async function({ api, event, args, models, Users, Threads, Currencies, permssion, envConfig }) {
    try {
        ...
        const activeKey = envConfig.apiKeys[Math.floor(Math.random() * envConfig.apiKeys.length)];
