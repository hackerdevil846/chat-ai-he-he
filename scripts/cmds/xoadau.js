...
module.exports.config = {
  ...
  role: 0,
  shortDescription: {
    en: "𝑃𝑎𝑡 𝑠𝑜𝑚𝑒𝑜𝑛𝑒'𝑠 ℎ𝑒𝑎𝑑"
  },
  longDescription: {
    en: "𝐺𝑒𝑛𝑡𝑙𝑦 𝑝𝑎𝑡 𝑡ℎ𝑒 ℎ𝑒𝑎𝑑 𝑜𝑓 𝑠𝑜𝑚𝑒𝑜𝑛𝑒 𝑦𝑜𝑢 𝑡𝑎𝑔"
  },
  category: "𝑙𝑜𝑣𝑒",
  guide: {
    en: "{p}xoadau [𝑡𝑎𝑔]"
...
module.exports.onStart = async function({ api, event, args, message }) {
  try {
    // Check dependencies
    if (!request) throw new Error("𝑟𝑒𝑞𝑢𝑒𝑠𝑡 𝑚𝑜𝑑𝑢𝑙𝑒 𝑛𝑜𝑡 𝑓𝑜𝑢𝑛𝑑");
    if (!fs) throw new Error("𝑓𝑠 𝑚𝑜𝑑𝑢𝑙𝑒 𝑛𝑜𝑡 𝑓𝑜𝑢𝑛𝑑");
    ...
    if (Object.keys(event.mentions).length === 0) {
      return message.reply("𝑉𝑢𝑖 𝑙ò𝑛𝑔 𝑡𝑎𝑔 1 𝑛𝑔ườ𝑖");
    }
    ...
    console.error("𝑋𝑜𝑎 đầ𝑢 𝑒𝑟𝑟𝑜𝑟:", error);
    message.reply("❌ 𝐶ó 𝑙ỗ𝑖 𝑥ả𝑦 𝑟𝑎: " + error.message);
  }
};
